...
def run(width=1024, height=1024):
    ...
    root = Tk()
    init(data)
    image = Image.open('/Users/kategroschner/Box Sync/Research/HR-TEM/20180227/20180227_101729F_prepped20171204/8bit/20180227_101729F_plasma15sec_Mh370kx__0001.tif')
